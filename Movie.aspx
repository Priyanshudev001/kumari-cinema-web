<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Movie.aspx.cs" Inherits="WebApplication.Movie" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Kumari Cinemas - Movie</title>
    ...
    <form id="form1" runat="server">
        <div class="page-shell">
            <header class="page-header">
                <div>
                    ...
                    <p class="page-subtitle">Create, update, and review movie records.</p>
                </div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="MOVIEID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="RELEASEWEEK" HeaderText="RELEASEWEEK" SortExpression="RELEASEWEEK" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM &quot;MOVIE&quot; WHERE &quot;MOVIEID&quot; = :MOVIEID" InsertCommand="INSERT INTO &quot;MOVIE&quot; (&quot;MOVIEID&quot;, &quot;MOVIETITLE&quot;, &quot;GENRE&quot;, &quot;DURATION&quot;, &quot;RELEASEWEEK&quot;) VALUES (:MOVIEID, :MOVIETITLE, :GENRE, :DURATION, :RELEASEWEEK)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM &quot;MOVIE&quot;" UpdateCommand="UPDATE &quot;MOVIE&quot; SET &quot;MOVIETITLE&quot; = :MOVIETITLE, &quot;GENRE&quot; = :GENRE, &quot;DURATION&quot; = :DURATION, &quot;RELEASEWEEK&quot; = :RELEASEWEEK WHERE &quot;MOVIEID&quot; = :MOVIEID">
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="RELEASEWEEK" Type="String" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="MOVIETITLE" Type="String" />
                <asp:Parameter Name="GENRE" Type="String" />
        ...
        <asp:FormView ID="FormView1" runat="server" CellPadding="4" DataKeyNames="MOVIEID" DataSourceID="SqlDataSource1" ForeColor="#333333">
            <EditItemTemplate>
                ...
                <br />
                RELEASEWEEK:
                <asp:TextBox ID="RELEASEWEEKTextBox" runat="server" Text='<%# Bind("RELEASEWEEK") %>' />
                <br />
            ...
            <ItemTemplate>
                ...
                <br />
                RELEASEWEEK:
                <asp:Label ID="RELEASEWEEKLabel" runat="server" Text='<%# Bind("RELEASEWEEK") %>' />
                <br />
        ...
        <p>
            <asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSource1">
                <Series>
                    <asp:Series Name="Series1" XValueMember="DURATION" YValueMembers="MOVIEID">
                    </asp:Series>
                </Series>
                <ChartAreas>
